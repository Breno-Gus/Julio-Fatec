<main role="main" class="flex-shrink-0">
  <div class="container">
    <div class="row">
      ...
      <p><strong>Login:</strong> <?php echo htmlspecialchars($viewVar['usuario']->getLogin()); ?></p>
        ...
        <form action="<?php echo 'http://'.APP_HOST.'/usuario/salvar/editar';?>" method="post" id="formEditarUsuario">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control <?php if ($Sessao::retornaErro('errosenha')!="") echo "is-invalid"; ?>" name="senha" value="<?php echo $viewVar['usuario']->getSenha(); ?>">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="permissao" required>
              ...
              <option value="Admin" <?php if($viewVar['usuario']->getPermissao() === 'Admin') echo 'selected'; ?>>Admin</option>
              <option value="Normal" <?php if($viewVar['usuario']->getPermissao() === 'Normal') echo 'selected'; ?>>Normal</option>
              <option value="Leitura" <?php if($viewVar['usuario']->getPermissao() === 'Leitura') echo 'selected'; ?>>Leitura</option>
            </select>
          </div>
